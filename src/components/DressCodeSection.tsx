        ...
        <Reveal>
          <>
            <SectionTitle
              ...
              title="Дресс-код"
              description="Будет особенно красиво, если в образе появятся оттенки зелени, молочного, тёплого дерева и мягкого серого. Это совсем не обязательно: мы любим тебя в любом образе."
            />
