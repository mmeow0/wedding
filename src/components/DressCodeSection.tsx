        ...
        <Reveal>
          <>
            <SectionTitle
              ...
              title="Дресс-код"
              description="Будет особенно красиво, если в образах появятся оттенки зелени, молочного, тёплого дерева и мягкого серого. Это совсем не обязательно: мы любим вас в любом образе."
            />
