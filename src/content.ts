...
export const storyMoments: readonly StoryMoment[] = [
  ...
  },
  {
    ...
    image: "/11.jpeg",
    imageAlt: "Рисованные Айгуль и Евгений в тёплом путешествии по Турции",
    caption: "Турция"
  },
  {
    number: "12",
    title: "А ПОТОМ У НАС ПОЯВИЛАСЬ СНЕЖА",
    text: "После Турции в нашей жизни случилась ещё одна важная встреча: уже в Москве мы забрали из подвала чёрную бездомную кошечку Снежу. Так наша семья стала ещё больше и ещё пушистее.",
    image: "/12.jpeg",
